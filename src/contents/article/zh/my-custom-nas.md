...
总价 ￥ 1161.8 ，在 618 前买的，部分配件还进行了保价退了点钱（京东的服务就是好）。 迷你主机不需要风扇降温，而且送了电源适配器，所以这些配件的钱都省了下来。

里面之所以有多一个固态硬盘是因为迷你主机支持插一个 mSATA 的 SSD ，刚好现在 SSD 价格又不贵，内置一个 SSD 用来装系统，然后机械硬盘就可以完全当存储盘用了。
