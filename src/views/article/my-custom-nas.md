...
既然选择自己配 NAS 做一个 DIY 玩家，肯定还是需要先熟悉一些前置的硬件知识，否则大可花几千块钱买成品 NAS 了。

### 主要配件

组 NAS 有很多种方案，例如后面要介绍的迷你主机 + 外置硬盘，或者是纯 DIY 一个 NAS ，一般来说硬盘都是要单独选购，而其他的如 CPU 、主板、机箱等配件通常会放在一起选购。

所以先介绍一下主要配件。

#### CPU

NAS 主要还是服务于数据存储的需求，所以一般会选择低功耗的 CPU ，通常选择笔记本电脑等级的 Intel Core i3 至 i5 低压 CPU ，只做存储的话一般 i3 是够用的，如果要玩 VM 或者 Docker 可能得上 i5 ，但是太强的 CPU 也没必要，大材小用了。

不论是自组 NAS 还是买迷你主机，都是优先考虑 CPU ，再去自己搭配主板等其他配件。
